  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text("Devlet Kurumları",style: GoogleFonts.oswald(textStyle: TextStyle(color:Colors.orange)))),
        body: Center(
            child:
                        ...
                        children: <Widget>[
                          ...
                          new SizedBox(
                              ...
                              child: new IconButton(
                                ...
                                icon: new Icon(Icons.directions_run_rounded, color: Colors.orange, size: 50),
                                onPressed: (){
                                  Navigator.push(
                                    context,
                    ...
                    Row(
                        ...
                        children: <Widget>[
                          ...
                          new SizedBox(
                              ...
                              child: new IconButton(
                                padding: new EdgeInsets.all(0.0),
                                icon: new Icon(Icons.account_balance, color: Colors.orange, size: 50),
                                onPressed: (){
...
class __GocIdaresi extends State<GocIdaresi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Göç İdaresi',style: TextStyle(color: Colors.black54),),
      ),
      body: const WebView(
...
class __Emniyet extends State<Emniyet> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Emniyet Müdürlüğü',style: TextStyle(color: Colors.black54),),
      ),
      body: const WebView(
...
class __Adliye extends State<Adliye> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ADLİYE',style: TextStyle(color: Colors.black54),),
      ),
      body: const WebView(
...
class __Belediye extends State<Belediye> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('BELEDİYE',style: TextStyle(color: Colors.black54),),
      ),
      body: const WebView(
...
class __Valilik extends State<Valilik> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Valilik',style: TextStyle(color: Colors.black54),),
      ),
      body: const WebView(
        initialUrl: "https://www.google.com/maps/place/Rize+Valili%C4%9Fi/@41.028396,40.5134692,17z/data=!3m1!4b1!4m5!3m4!1s0x40667ae728f9de09:0x67e7a986de82d605!8m2!3d41.028392!4d40.5156579" ,
        javascriptMode: JavascriptMode.unrestricted,
