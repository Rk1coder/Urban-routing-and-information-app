  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text("Sağlık Kuruluşları",style: GoogleFonts.oswald(textStyle: TextStyle(color:Colors.orange)),)
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                child: const Text('   Hastaneler   ',style: TextStyle(color: Colors.black54), ),
              ),
              ...
              ElevatedButton(
                ...
                child: const Text('     Eczaneler     ',style: TextStyle(color: Colors.black54),),
              ),
              SizedBox(height: 25),
              ...
              ElevatedButton(
                ...
                child: const Text('   Aşı Takvimi   ',style: TextStyle(color: Colors.black54),),
              ),
...
class HastaneList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text("Hastaneler",style: TextStyle(color: Colors.white),)),
        body: Center(
      child: Column(
                  ...
                  children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          new SizedBox(
                              ...
                              child: new IconButton(
                                ...
                                icon: new Icon(Icons.medical_services_outlined, color: Colors.orange, size: 30),
                                onPressed: (){
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Hastane Konumları',style: TextStyle(color: Colors.white),),
                    ),
                ...
                Row(
                    ...
                    children: <Widget>[
                      ...
                      new SizedBox(
                          ...
                          child: new IconButton(
                            padding: new EdgeInsets.all(0.0),
                            icon: new Icon(Icons.local_pharmacy_outlined, color: Colors.orange, size: 30),
                            onPressed: (){
