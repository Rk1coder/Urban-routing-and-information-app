...
class SeferSaatleri extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text("Ulaşım",style: TextStyle(color: Colors.orange),),backgroundColor: Colors.black54,),
        body: Center(
            child:
              ...
              child : Column(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      child: const Text('Durak Konumları',style: TextStyle(color: Colors.white, ),),
                    ),
...
class __Ulasim extends State<Ulasim> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Durak Konumları',style: TextStyle(color: Colors.orange,backgroundColor: Colors.black54),),
      ),
      body: const WebView(
