...
class _Eglence extends State<Eglence> {
  ...
  static const List<String> bilmece = ["Ağızı haho, deliği vizo, zaçada ziço, zaçada ziço ",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Eğlenelim Öğrenelim",style: GoogleFonts.oswald(textStyle: TextStyle(color: Colors.orange,)))
      ),
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                ...
                child: const Text('Yeni bilmece/tekerleme üret',style: TextStyle(color: Colors.white),),
              ),
            ]
        ),
      ),
